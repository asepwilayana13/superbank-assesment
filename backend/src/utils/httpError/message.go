...
var (
	...
	CreateSessionError    = errors.New("failed to create session")
	InvalidPassword       = errors.New("Invalid password")
	InvalidGenerateToken  = errors.New("Failed to generate token")
	NotFoundSession       = errors.New("Session Not Found")
